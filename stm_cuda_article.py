...
MODEL_PATH = f'model-output-data/{DATA_SET}-results-cuda'
...
epochs = {"ag": 10, "bbc": 20, "20news": 10}
etas = {"ag": 0.0001, "bbc": 0.001, "20news": 0.0001}
batch_size = {"ag": 5000, "bbc": 2225, "20news": 5000}
...
if __name__ == '__main__':
    ...
    for i in range(5):
        for N in [20, 30, 40]:
            ...
            DATA_SET_PATH = f'{MODEL_PATH}/{Batch_Size}'
            ...
            stmModel = STMGPUrunner(FEATURE_LIMIT,
                                    ...
                                    threshold=0.1,
                                    squuze=3,
                                    learning_rate=etas[DATA_SET])
            stmModel.train(loader, epochs[DATA_SET], 50)
